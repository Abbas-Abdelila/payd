...
const Edit = () => {
    ...
    try {
      const res = await fetch(process.env.VITE_APP_SERVER_URL + "/api/products/get-all")
  ...
  useEffect(() => {
    ...
    try {
      const res = await fetch(process.env.VITE_APP_SERVER_URL + "/api/categories/get-all")
      const data = await res.json()
  ...
  getCategories()
    ...
    const  onFinish = (values) => {
        try {
            fetch(process.env.VITE_APP_SERVER_URL + "/api/products/update-product", {
                method: "PUT",
    ...
    const deleteProduct = (id) => {
            ...
            if (window.confirm("Are you sure you want to delete category?")) {
                    try {
                fetch(process.env.VITE_APP_SERVER_URL + "/api/products/delete-product", {
                    method: "DELETE",
